-- ══════════════════════════════════════════════════════════════════════════════
-- FUNDEDWEALTH TERMINAL — MASTER MIGRATION
-- ══════════════════════════════════════════════════════════════════════════════
-- Date: 2026-06-20
-- Target: Supabase (PostgreSQL 15+)
-- Tables: 16 new terminal tables
-- 
-- PRESERVES (DO NOT TOUCH): users, orders, sessions, kyc_*
-- 
-- Execution Order:
--   Phase 1: terminal_users
--   Phase 2: challenges, terminal_sessions, watchlists
--   Phase 3: terminal_accounts
--   Phase 4: risk_rules, account_metrics, terminal_orders, terminal_positions,
--            audit_log, risk_events, broker_sessions, payouts
--   Phase 5: terminal_trades, order_audit, challenge_metrics
...
-- ═══════════════════════════════════════════════════════════════════════════
-- PHASE 1: terminal_users (depends on platform `users`)
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- PHASE 2: challenges, terminal_sessions, watchlists (depend on terminal_users)
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- PHASE 3: terminal_accounts (depends on terminal_users + challenges)
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- PHASE 4: Tables depending on terminal_accounts
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- PHASE 5: Tables depending on terminal_orders + terminal_accounts
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- PHASE 6: Triggers + Row Level Security
-- ═══════════════════════════════════════════════════════════════════════════
...
-- Platform tables preserved: users, orders, sessions (UNTOUCHED)
-- ══════════════════════════════════════════════════════════════════════════════
